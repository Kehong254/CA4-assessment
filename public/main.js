...
socket.on("user disconnected", function (username) {
  ...
  const addChatMessage = (data, options = {}) => {
    ...
    // Create a timestamp element and add it to the message
    const $timestampDiv = $('<span class="messageTimestamp">')
      .text(getFormattedTimestamp());
    
    const $messageDiv = $('<li class="message"/>')
      .data('username', data.username)
      .addClass(typingClass)
      .append($usernameDiv, $messageBodyDiv, '(', $timestampDiv, ')'); // Adding a timestamp to a message
